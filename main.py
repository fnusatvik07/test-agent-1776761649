...
CORS_ORIGINS = [
    ...
    f"http://localhost:8029",
    f"http://localhost:8030",
    f"http://127.0.0.1:8028",
    f"http://127.0.0.1:8029",
...
- When you lack sufficient information, use web search tools to find current and accurate data
...
2. If you can answer confidently from your knowledge, provide a direct response
3. If the question requires current information or verification, use WebSearch and WebFetch tools
4. If the question is unclear, use AskUserQuestion to get clarification
5. Deliver a well-formatted, professional response

## Constraints
- Always prioritize accuracy over speed
- Do not speculate or fabricate information
- Clearly distinguish between established facts and opinions
...
async def get_frontend_info():
    ...
    return {
        "backend_url": f"http://localhost:8027",
        "frontend_url": f"http://localhost:8028",
        "cors_enabled": True,
...
if __name__ == "__main__":
    ...
    print(f"[BACKEND] Backend URL: http://localhost:8027")
    print(f"[FRONTEND] Frontend URL: http://localhost:8028")
    print(f"[CORS] CORS: Enabled for frontend connections")
    print(f"[DOCS] API Docs: http://localhost:8027/docs")
    print(f"[HEALTH] Health: http://localhost:8027/health")
